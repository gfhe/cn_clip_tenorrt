...
if __name__ == '__main__':
    ...
    dynamic_axes_image = {"image": {0: "batch"}, "unnorm_image_features": {0: "batch"}}
    text = clip.tokenize([""], context_length=args.context_length)
    dynamic_axes_text = {"text": {0: "batch"}, "unnorm_text_features": {0: "batch"}}
    ...
    if args.convert_vision:
        ...
        torch.onnx.export(model,
                    ...
                    dynamic_axes=dynamic_axes_image,
                    #opset_version=13,
                    verbose=True)
